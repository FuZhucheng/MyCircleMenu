...
public class CircleMenuLayout extends ViewGroup
{
	...
	protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec)
	{
		...
		System.out.println("11111111mRadius:"+mRadius);
...
//			} else
	...
	protected void onLayout(boolean changed, int l, int t, int r, int b)
	{
		...
		System.out.println("11111111:"+childCount);
...
//				continue;
			...
			System.out.println("111111111mStartAngle:"+mStartAngle);
			System.out.println("111111111left:"+left);



			                         // 为什么要1 / 2f* cWidth呢，这个是左边上角的坐标，不是中心点的坐标
